...
data_cured_range <- data[j= .(.N), by = .(magnitude_cured)]
  ...
  benford_first_two_confirmed <- plot_benford_leading(data$confirmed, 
    test.type = "First-Two Digits", 
    variable = "Confirmed")
  
  benford_first_two_deaths <- plot_benford_leading(data$deaths, 
    test.type = "First-Two Digits", 
    variable = "Deaths")
   
  benford_first_two_cured <- plot_benford_leading(data$cured, 
    test.type = "First-Two Digits", 
    variable = "Cured")
...
for(region in 1:nrow(scotland_state)) {
  ...
  benford_first_two_confirmed <- plot_benford_leading(tests$positive, 
    test.type = "First-Two Digits", 
    subtitle = "",
    variable = "Confirmed")
  
  benford_first_two_deaths <- plot_benford_leading(deaths$deaths, 
                                           test.type = "First-Two Digits", 
                                           subtitle = "",
                                           variable = "Deaths")
...
saveRDS(theBenford, file="theBenford.RDS")
